...
// Court Network
const url = 'http://192.168.1.100:5000/posts'; // (Court) this is accessible from local network i.e mobiles etc, the ip is wireless wifi's ipv4 address
const urlCases = 'http://192.168.1.100:5000/cases';
const urlEmployeeData = 'http://192.168.1.100:5000/employeeData';
const urlQueryData = 'http://192.168.1.100:5000/api/queryData';
const urlCauseLists = 'http://192.168.1.100:5000/api/causeLists';
const urlControlCenter = 'http://192.168.1.100:5000/api/controlCenter';
const urlpqsp = 'http://192.168.1.100:5000/pqsp';
