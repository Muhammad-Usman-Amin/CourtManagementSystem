...
export default function CasesListTable({ currentId, setCurrentId, onPageChange }) {
                ...
                <Table ref={tableRef} stickyHeader size="small" className={classes.table} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell component="th" scope="row" align="left">Case NO</TableCell>
                    ...
                    <TableBody>
                        {cases.map((row) => (
                            <TableRow hover key={row._id}>
                                ...
                                <TableCell align="left">{format?.(parseISO(row["Date of Institution "]), "dd-MM-yyy")}</TableCell>
                                <TableCell align="left">{row["Institution Year"]}</TableCell>

                                <TableCell align="left">
                                    <Button size='small' color='primary' component={Link} to='/FormCases'
